...
SELECCION:
	    ...
	    LCDWRITE P1\P3\P2, OUTB,[10,13,"1. CAMBIAR HORA"]
		LCDWRITE P1\P3\P2, OUTB,[10,13,"2. MEDIR TEMP"]
		LCDWRITE P1\P3\P2, OUTB,[10,13,"3. LEER EEPROM"]
		GOSUB LEER_HORA
		LCDWRITE P1\P3\P2, OUTB,[10,13," HORA  = ",DEC RTC(Hora),":",DEC RTC(Min),":",DEC RTC(Seg),13]
        LCDWRITE P1\P3\P2, OUTB,[" FECHA = ",DEC RTC(Dia),"/",DEC RTC(Mes),"/",DEC RTC(Ano)]
			PAX3=INAX3
			PAX2=INAX2
			PAX1=INAX1
...
CAMBIARHORA:
		...
		DO
		LCDWRITE P1\P3\P2, OUTB,[0]
		LCDWRITE P1\P3\P2, OUTB,["MIN: ",DEC RTC(MIN)]
		PAUSE 100
		IF INAX2=1 THEN
		RTC(MIN)=RTC(MIN)+$1
		ENDIF
		...
		DO
		LCDWRITE P1\P3\P2, OUTB,[0]
		LCDWRITE P1\P3\P2, OUTB,["SEG: ",DEC RTC(SEG)]
		PAUSE 100
		IF INAX2=1 THEN
		RTC(SEG)=RTC(SEG)+$1
		ENDIF
		...
		DO
		LCDWRITE P1\P3\P2, OUTB,[0]
		LCDWRITE P1\P3\P2, OUTB,["DIA: ",DEC RTC(DIA)]
		PAUSE 100
		IF INAX2=1 THEN
		RTC(DIA)=RTC(DIA)+$1
		ENDIF
		...
		DO
		SEROUT S_OUT,I9600,[0]
		LCDWRITE P1\P3\P2, OUTB,["MES: ",DEC RTC(MES)]
		PAUSE 100
		IF INAX2=1 THEN
		RTC(MES)=RTC(MES)+$1
		ENDIF
		...
		DO
		LCDWRITE P1\P3\P2, OUTB,[0]
		LCDWRITE P1\P3\P2, OUTB,["ANO: ",DEC RTC(ANO)]
		PAUSE 100
		IF INAX2=1 THEN
		RTC(ANO)=RTC(ANO)+$1
		ENDIF
